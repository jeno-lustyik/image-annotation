...
cv.putText(img_copy, 'Fry\'s Hair', (100, 15), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))

# Coat rectangle
cv.rectangle(img_copy, (100, 415), (370, 305), (0, 0, 255))
cv.rectangle(img_copy, (100, 305), (200, 280), (0, 0, 255), cv.FILLED)
cv.putText(img_copy, 'Fry\'s Coat', (100, 295), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))

# Face rectangle
cv.rectangle(img_copy, (230, 330), (390, 175), (0, 255, 255))
cv.rectangle(img_copy, (230, 175), (330, 150), (0, 255, 255), cv.FILLED)
cv.putText(img_copy, 'Fry\'s Face', (230, 165), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
